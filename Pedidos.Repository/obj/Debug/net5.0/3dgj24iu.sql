...
CREATE TABLE "tbl_Imagem" (
    ...
    CONSTRAINT "FK_tbl_Imagem_tbl_Produto_ProdutoID" FOREIGN KEY ("ProdutoID") REFERENCES "tbl_Produto" ("ID") ON DELETE RESTRICT
);
...
CREATE INDEX "IX_tbl_Imagem_ProdutoID" ON "tbl_Imagem" ("ProdutoID");
...
VALUES ('20210203002037_Init', '5.0.2');
